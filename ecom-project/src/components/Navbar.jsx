...
export function Navbar({totalQuantity}) {
  return (
    <nav className="w-full bg-red-600 flex justify-between items-center py-2 px-4 border-b-2 border-white
    top-0 fixed">
      <Link to="/">
        <div>
      ...
      <div className="flex text-white items-center gap-5">
        <span className="text-gray-200 hover:underline text-md cursor-pointer">Already have an account?</span>
